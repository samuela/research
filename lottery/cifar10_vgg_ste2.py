...
import wandb
from cifar10_vgg_run import (init_train_state, load_datasets, make_stuff, make_vgg_width_ablation)
...
if __name__ == "__main__":
  ...
  with wandb.init(
    ...
    config.params_represent = "midpoint"
    # config.params_represent = "b_endpoint"
    # config.projection_type = "l2"
    config.projection_type = "inner_product"
